...
// HasServiceVersions applies the HasEdge predicate on the "serviceVersions" edge.
func HasServiceVersions() predicate.Service {
	return predicate.Service(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ServiceVersionsTable, ServiceVersionFieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, ServiceVersionsTable, ServiceVersionsColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasServiceVersionsWith applies the HasEdge predicate on the "serviceVersions" edge with a given conditions (other predicates).
func HasServiceVersionsWith(preds ...predicate.ServiceVersion) predicate.Service {
	return predicate.Service(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ServiceVersionsInverseTable, ServiceVersionFieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, ServiceVersionsTable, ServiceVersionsColumn),
		)
