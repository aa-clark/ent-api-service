...
type ServiceEdges struct {
	// ServiceVersions holds the value of the serviceVersions edge.
...
// ServiceVersionsOrErr returns the ServiceVersions value or an error if the edge
// was not loaded in eager-loading.
func (e ServiceEdges) ServiceVersionsOrErr() ([]*ServiceVersion, error) {
	if e.loadedTypes[0] {
		return e.ServiceVersions, nil
	}
	return nil, &NotLoadedError{edge: "serviceVersions"}
}
...
// QueryServiceVersions queries the "serviceVersions" edge of the Service entity.
func (s *Service) QueryServiceVersions() *ServiceVersionQuery {
	return (&ServiceClient{config: s.config}).QueryServiceVersions(s)
}
